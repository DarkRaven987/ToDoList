module.exports = function(app, db) {
    ...
    app.post('/tasks/add', (req, res) => {
        let {task_title, user_id,} = req.body,
          query = `INSERT INTO tasks (task_title, task_description, task_status, category_id, user_id, task_created_date, task_updated_date) 
          VALUES ('${task_title}', 'test', 'neutral', '5','${user_id}', NOW(), NOW())`,
